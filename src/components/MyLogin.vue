    ...
    <div class="login-box">
      ...
      <div class="form-login p-4">
        ...
        <div class="form-group form-inline d-flex justify-content-end">
          <button type="button" class="btn btn-secondary mr-2" @click="remit">重置</button>
...
export default {
  ...
  methods:{
    ...
    login(){
      if(this.username==='admin' && this.password==='66666'){
        // 登录成功
          // 保存token  
          window.localStorage.setItem('token','Bearer xxxx')
          // 跳转后台'token'
